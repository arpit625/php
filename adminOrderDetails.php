...
mysql_select_db($database_online_order, $online_order);
// $query_rsOrderDetails = sprintf("SELECT temp_order_id,order_id, extra_price, price, item_name, extra_items_name,selected_options_name FROM cart_order_items WHERE order_id = %s", GetSQLValueString($colname_rsOrderDetails, "int"));
...
<a href="adminSearchOrder.php" class="btn btn-large " type="button"><i class="icon-align-justify"> </i> All Orders</a>
<a href="adminSearchOrder.php?url_daily_search=1" class="btn btn-large" type="button"><i class="icon-book"> </i> Daily Orders</a>
<a href="adminSearchOrder.php" class="btn btn-large" type="button"><i class="icon-backward"> </i> Back</a>
          ...
          <div class="row-fluid">
            <div class="span4">
             ...
             <strong> Order Time :</strong>
               ...
               <?php echo substr($row_rsUserInfo['order_time'],11,5); ?>
            </div>
