...
$query_rsOrderStatus = sprintf("SELECT * FROM order_updt_status WHERE status = '%s' AND userid = %s AND mainorder_id = %s",$colname_Status,GetSQLValueString($colname_rsUserInfo, "int"),$colname_rsOrderDetails);
