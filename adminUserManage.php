...
<a href="adminHome.php" class="btn btn-large" type="button"><i class="icon-backward"> </i> Back</a>
  ...
  <tr>
    ...
    <td>
      <a href="adminEnableDisable.php?url_user_status=enable&url_status=<?php echo $row_rsUsers['status']; ?>&userID=<?php echo $row_rsUsers['userid'];?>">
    ...
    <td>
      <a href="adminEnableDisable.php?url_user_status=disable&url_status=<?php echo $row_rsUsers['status']; ?>&userID=<?php echo $row_rsUsers['userid'];?>">
    ...
    <td><a href="delete.php?statusID=<?php echo $row_rsUsers['status']; ?>&userID=<?php echo $row_rsUsers['userid'];?>">
      <button class="btn btn-danger" type="button">Delete</button>
    </a></td>
    <td><a href="adminEditUser.php?statusID=<?php echo $row_rsUsers['status']; ?>&userID=<?php echo $row_rsUsers['userid'];?>">
